...
import (
	...
	// "github.com/FloatTech/ZeroBot-Plugin/plugin/bookreview"       // 哀伤雪刃吧推书记录
	...
	// "github.com/FloatTech/ZeroBot-Plugin/plugin/dish"             // 程序员做饭指南
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "汐月喵", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:       append([]string{*adana}, "yaoyao", "小汐" ),
